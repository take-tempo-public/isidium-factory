...
```toml
history = [
  { seq = 1, at = "2026-08-20T14:02:11Z", by = "amodal1@example", act = "created", fields = ["title"], build = "sha256:b889cb2615200657f948c145cbd8c9e1b046b3308117359dc5fe7321fdf42943", h = "sha256:0" },
]
```
