...
```toml
history = [
  { seq = 1, at = "2026-08-20T14:02:11Z", by = "amodal1@example", act = "created", fields = ["title"], build = "sha256:0117031b1f5c2352ded3b72651f73656c46e6d847df6f182697eb5846887a71a", h = "sha256:0" },
]
```
