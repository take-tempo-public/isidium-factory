...
```toml
history = [
  { seq = 1, at = "2026-08-20T14:02:11Z", by = "amodal1@example", act = "created", fields = ["title"], build = "sha256:b2d1d057ab610151d6d890bf2f34f7be13222dee0f8363437c4f0de226a95e99", h = "sha256:0" },
]
```
