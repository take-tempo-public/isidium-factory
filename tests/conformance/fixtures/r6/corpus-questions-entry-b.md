...
```toml
history = [
  { seq = 1, at = "2026-08-20T14:02:11Z", by = "amodal1@example", act = "created", fields = ["title"], build = "sha256:418dee8eb377d38f48411f9bdff39b6420ba5ff1a9d903ae32146bfccbf9126d", h = "sha256:0" },
]
```
