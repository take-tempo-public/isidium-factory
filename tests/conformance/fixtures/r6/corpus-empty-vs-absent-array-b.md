...
```toml
history = [
  { seq = 1, at = "2026-08-20T14:02:11Z", by = "amodal1@example", act = "created", fields = ["title"], build = "sha256:aac0585ca4d9a71b140e20d35f9ffe57e3d1cf6634bf2abeb440469249c5ae5f", h = "sha256:0" },
]
```
