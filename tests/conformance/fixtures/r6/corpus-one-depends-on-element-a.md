...
```toml
history = [
  { seq = 1, at = "2026-08-20T14:02:11Z", by = "amodal1@example", act = "created", fields = ["title"], build = "sha256:287ede1ea8b846179240db949ee6c3aec8e4b2656d1b6ff682ec47ffee109241", h = "sha256:0" },
]
```
