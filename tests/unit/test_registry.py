...
def test_d1_fixtures_validate() -> None:
    ...
    # the version that does not ship: `config@6` since V3 shipped `config@5` (the arm moved once more)
    unshipped = text.replace("schema = 2", "schema = 6", 1).replace('schema = "config@2"', 'schema = "config@6"', 1)
